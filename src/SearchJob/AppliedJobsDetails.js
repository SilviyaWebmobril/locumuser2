...
const AppliedJobsDetails =(props) => {
    ...
    const application_status = useState(props.navigation.getParam('application_status'));
                ...
                dispatch(checkuserAuthentication(user_id,device_token))
                    .then(response =>{
                        ...
                        if(response.data.error){
                            showMessage(0, 'Session Expired! Please Login.', 'Applied Job Details', true, false);
                            dispatch(logoutUser());
                            ...
                            dispatch(onCancelJob(user_id,appid[0],props.navigation));
                        }
                    })
    ...
    return(
        ...
        <View style={styles.container}>
            ...
            ?
            <View style={styles.viewRow}>
                <View style={{flexDirection:'row',justifyContent:'flex-end',alignItems:'flex-end',width:'90%',marginTop:20}}>
